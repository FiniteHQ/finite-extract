...
incident-tier: { swift-package: n/a }
license: MIT
...
## Surface: swift-package (Sources/)

- Scope: ``Sources/``
- Swift Package Manager library. SwiftFormat + SwiftLint.
- Coverage: 80% diff gate.
- Release: semver git tags; API stability is a review concern from 1.0.
- Public packages: docs + Examples current with API; SECURITY.md present.
